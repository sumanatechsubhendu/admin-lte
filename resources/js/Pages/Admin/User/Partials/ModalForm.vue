        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <option v-for="option in status_options" :value="option.value">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="role_id" v-model="form.role" class="mt-1 block w-full">
                ...
                <div class="modal-footer">
                    <button type="button" id="modalCloseDiv" class="btn btn-secondary" data-dismiss="modal">Close</button>
